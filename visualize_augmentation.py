...
"""
    ./visualise_transformations.py -i splits/val_remapped.txt 
...
ap.add_argument    ('-i', '--input', help = 'path of the input file', default='splits/val_5.7k_cropped_remapped.txt')
args = ap.parse_args()
...
def main():
    workers         = 3
    img_dim         = 224
    test_repeat     = 5     # No of times augmentation to be done
    test_batch_size = 512   
    ...
    dataset_from_csv2 = CustomDatasetFromCSVTrain(input_file, img_dim, img_dim, transformations)
    ...
    # Visualise the original and augmented images
