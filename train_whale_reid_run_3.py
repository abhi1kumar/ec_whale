...
train_file      = "splits/train_remapped.txt"
val_file        = "splits/val_remapped.txt"
...
dataset_from_csv  = CustomDatasetFromCSVTrain(train_file, height = img_dim, width = img_dim, transforms = transformations2)
